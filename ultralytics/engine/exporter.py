...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel, SegPoseModel
...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        output_names = ["output0", "output1"] if isinstance(self.model, SegmentationModel) or isinstance(self.model, SegPoseModel) else ["output0"]
        dynamic = self.args.dynamic
        if dynamic:
            dynamic = {"images": {0: "batch", 2: "height", 3: "width"}}  # shape(1,3,640,640)
            if isinstance(self.model, SegmentationModel) or isinstance(self.model, SegPoseModel):
