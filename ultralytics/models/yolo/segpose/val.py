...
from ultralytics.utils.metrics import SegPoseMetrics, box_iou, mask_iou, OKS_SIGMA, kpt_iou
...
class SegPoseValidator(DetectionValidator):
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        self.metrics = SegPoseMetrics(save_dir=self.save_dir)
    ...
    def _prepare_pred(self, pred, pbatch, proto):
        ...
        pred_masks = self.process(proto, pred[:, 6:-self.kpt_shape[0] * self.kpt_shape[1]], pred[:, :4],
                                  shape=pbatch["imgsz"])
    ...
    def update_metrics(self, preds, batch):
        ...
        for si, (pred, proto) in enumerate(zip(preds[0], preds[1])):
            ...
            if nl:
                ...
                stat["tp_m"] = self._process_batch_mask(
                    predn, bbox, cls, pred_masks, gt_masks, self.args.overlap_mask, masks=True
                )
                stat["tp_p"] = self._process_batch_kpt(predn, bbox, cls, pred_kpts, pbatch["kpts"])
            if self.args.plots:
    ...
    def _process_batch_mask(self, detections, gt_bboxes, gt_cls, pred_masks=None, gt_masks=None, overlap=False,
                            masks=False):
        """
    ...
    def _process_batch_kpt(self, detections, gt_bboxes, gt_cls, pred_kpts=None, gt_kpts=None):
        """
    ...
    def save_one_txt(self, predn, pred_masks, pred_kpts, save_conf, shape, file):
